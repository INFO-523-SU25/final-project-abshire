...
# Summarized data in a DataFrame
zone_data = {
...
```{python}
#| label: launch speed by pitch group
#| message: false
#| echo: false
...
for ax, pg in zip(axes.flatten(), pitch_groups):
    # Filter data for the pitch group
    ...
    # Map values to strike zone grid
    heatmap_values = zone_grid.replace(
    ...
    sns.heatmap(
        ...
        cmap="RdYlGn",
        linewidths=1,
        cbar_kws={'label': 'Mean Launch Speed (mph)'},
        vmin=80,
        vmax=105,
        ax=ax
    )
