...
display(df.head(3))  # just first 3 rows

# Summary of missing values
missing_percent = df.isnull().mean().sort_values(ascending=False) * 100
display(missing_percent.head(5))  # top 5 columns with missing data

# Summary of key categorical columns
for col in ['stand','p_throws','pitch_type','description','events']:
